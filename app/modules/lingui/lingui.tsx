...
import { type action, type RootLoaderType } from '~/root';
...
export function getLanguages(): Array<{
  ...
  return [
    ...
    { key: 'zh', label: msg`Simplified Chinese` },
  ];
}
...
export function LocaleSelector(props: ComponentProps<'select'>) {
  ...
  return (
    <select name='locale' value={locale} onChange={(e) => setLocale(e.currentTarget.value)} {...props}>
